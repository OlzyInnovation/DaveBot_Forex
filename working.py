...
# Moving Averages
# five_minutes_moving_average: float = 0
# fifteen_minutes_moving_average: float = 0
# one_hour_moving_average: float = 0
# four_hour_moving_average: float = 0
# one_day_moving_average: float = 0
        ...
        if period == '5MIN':
            ...
            for i in range(0, total_range):
                ...
                if not res_cond1 and not sup_cond1:
                    unsuccess_five_min.insert(i, 1)
                    print(str(i) + ' unsuccess')
                else:
                    # Is Resistance
                    if res_cond1:
                        if res_cond2:
                            success_five_min.insert(i, 1)
                            print('RES SUCCESS')
            ...
            # try:
            #     resistance = unsuccessful / successful
            #     if resistance >= 0.5:
            #         black_x_resistance_running_count_five_min += 1
            #     else:
            #         black_x_resistance_running_count_five_min = 0
            #     print(f'{period} resistance black x {black_x_resistance_running_count_five_min}')
            #     print("-------------")
